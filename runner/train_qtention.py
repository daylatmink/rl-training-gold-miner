...
from trainer.DoubleQtentionTrainer import DoubleQtentionTrainer


def main():
    parser = argparse.ArgumentParser(description='Train Qtention network with Double DQN')
    ...
    # Buffer
    parser.add_argument('--warmup-buffer', type=str, default='buffers/warmup_buffer_qtention.pkl',
                        help='Path to warmup buffer (default: buffers/warmup_buffer_qtention.pkl)')
    ...
    parser.add_argument('--d-ff', type=int, default=48,
                        help='Feedforward dimension (default: 48)')
    parser.add_argument('--nhead', type=int, default=8,
                        help='Number of attention heads (default: 8)')
    parser.add_argument('--n-layers', type=int, default=6,
                        help='Number of transformer layers (default: 6)')
    parser.add_argument('--n-actions', type=int, default=50,
                        help='Number of actions (default: 50)')
    parser.add_argument('--max-items', type=int, default=30,
                        help='Max items per state (default: 30)')
    ...
    # Saving
    parser.add_argument('--save-dir', type=str, default='checkpoints/qtention',
                        help='Directory to save checkpoints (default: checkpoints/qtention)')
    parser.add_argument('--log-file', type=str, default='training_qtention.log',
                        help='Log file path (default: training_qtention.log)')
    ...
    print(f"\n{'='*70}")
    print("Double Qtention Training Setup")
    print(f"{'='*70}")
